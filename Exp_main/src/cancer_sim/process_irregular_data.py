...
def transform_data(
    ...
    #data["training_data"]["obs_probabilities"] = np.ones_like(data["training_data"]["obs_probabilities"])
    #data["validation_data"]["obs_probabilities"] = np.ones_like(data["validation_data"]["obs_probabilities"])
