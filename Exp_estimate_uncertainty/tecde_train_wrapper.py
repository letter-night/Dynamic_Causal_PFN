...
# from Code.tecde_model_dropout_vectorfield import TE_CDE_dropout_vectorfield
from pytorch_lightning.loggers.csv_logs import CSVLogger


def tecde_train(hyperparams: dict,
                data_path,
                load_pickle,
    ...
    if hyperparams['dropout_type'] == 'dropout_head':
        model_class = TE_CDE_dropout_head
    else:
        # model_class = TE_CDE_dropout_vectorfield
        pass 

    # 2) Instantiate TE-CDE
    model = model_class(mc_samples=hyperparams['mc_samples'],hidden_size=hyperparams['hidden_size'],
                        hidden_layers=hyperparams['hidden_layers'],
                        dropout_probability=hyperparams['dropout_probability'],
